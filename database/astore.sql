...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2022 at 12:04 PM
...
INSERT INTO `products` (`id`, `name`, `catagory`, `price`, `UnitsInStock`, `Description`, `ManufactureYear`, `image`, `ProductSlug`, `Feature`) VALUES
...
ALTER TABLE `products`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Products_Categories` (`catagory`),
...
ALTER TABLE `order details`
  ...
  ADD CONSTRAINT `FK_Order_Details_Products` FOREIGN KEY (`ProductID`) REFERENCES `products` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `FK_Products_Categories` FOREIGN KEY (`catagory`) REFERENCES `categories` (`CategoryID`) ON DELETE CASCADE;
COMMIT;
